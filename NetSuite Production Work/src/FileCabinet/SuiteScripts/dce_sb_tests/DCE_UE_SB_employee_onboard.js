  ...
  const afterSubmit = (context) => {
    ...
    if (employeeEmail) {
      ...
      task.setValue({
        ...
        Please be aware that Suzanne will be in contact with you to schedule a meeting to go through 
        ...
        the manuals and Suzanne has done the induction with you. Thanks.
      `,
        // ignoreFieldChange: boolean
      });
      ...
      email.send({
        ...
        body: `
          ...
          the manuals and Suzanne has done the induction with you. Thanks.
        `,
        cc: ["suzanne@dce.co.nz"], // CC email addresses
      });
    }
  };
